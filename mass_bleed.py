...
start_range = raw_input("Enter a Jio Number from where you want to start digging data")
start_end = raw_input("Enter a Jio Number from where you want to stop digging data: ")
mass_bleed()
